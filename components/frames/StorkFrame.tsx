  ...
  return (
    <Svg width={width} height={height} viewBox={`0 0 ${W} ${H}`}>
      <Defs>
        ...
        <ClipPath id={`sclip${uid}`}>
          <Circle cx={CX} cy={CY} r={CR} />
        </ClipPath>
      </Defs>

      {/* Sky */}
      <Rect x="0" y="0" width={W} height={H} fill={`url(#ssky${uid})`} />

      {/* Scattered stars */}
      {[
        { x: 120, y: 100, s: 20 }, { x: 300, y: 60, s: 15 },
        { x: 500, y: 120, s: 18 }, { x: 780, y: 80, s: 22 },
        { x: 920, y: 140, s: 16 }, { x: 160, y: 1200, s: 14 },
        { x: 400, y: 1250, s: 18 }, { x: 700, y: 1180, s: 16 },
        { x: 900, y: 1230, s: 20 },
      ].map(({ x, y, s }, i) => (
        <Path
          key={i}
      ...
      <G transform="translate(100, 300) scale(0.8)">
        ...
        <Path d="M170,45 Q200,60 190,85 Q175,95 160,85 Q150,65 170,45 Z" fill={c.ribbon} opacity={0.7} />
      ...
      {/* Hearts */}
      {[
        { x: 250, y: 800, s: 1.2 }, { x: 830, y: 780, s: 1.0 },
        { x: 150, y: 950, s: 0.8 }, { x: 920, y: 920, s: 0.9 },
      ].map(({ x, y, s }, i) => (
        <Path
          key={i}
      ...
      <Path d="M0,1200 Q270,1170 540,1190 Q810,1210 1080,1180 L1080,1210 Q810,1240 540,1220 Q270,1200 0,1230 Z" fill={c.ribbon} opacity={0.3} />
      <Path d="M0,1250 Q270,1230 540,1245 Q810,1260 1080,1240 L1080,1350 L0,1350 Z" fill={c.ribbon} opacity={0.15} />
      ...
      {photoUri ? (
        <SvgImage
          ...
          href={photoUri} clipPath={`url(#sclip${uid})`} preserveAspectRatio="xMidYMid slice"
        />
      ) : (
