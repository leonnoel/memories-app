...
export function MoonFrame({
  ...
  return (
    <Svg width={width} height={height} viewBox={`0 0 ${W} ${H}`}>
      ...
      {/* Moon glow */}
      <Circle cx="870" cy="200" r="180" fill="url(#moonGlow)" />
      ...
      {/* Branch at bottom */}
      <Path
        d="M0,1100 Q100,1080 200,1100 Q300,1120 400,1090 Q500,1060 550,1080"
        stroke={c.branch}
        strokeWidth="12"
        fill="none"
        strokeLinecap="round"
      ...
      <Path
        d="M1080,1150 Q980,1130 900,1160 Q820,1190 780,1170"
        stroke={c.branch}
        strokeWidth="10"
        fill="none"
        strokeLinecap="round"
      ...
      {/* Small sleeping bird on right branch */}
